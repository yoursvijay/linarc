...
(function (root, factory) {
  ...
  Dragdealer.prototype = {
    ...
    getLooseValue: function(value) {
      ...
      return [
        proper[0] + ((value[0] - proper[0]) / 3),
        proper[1] + ((value[1] - proper[1]) / 3)
      ];
    },
  ...
  var draggie = new Dragdealer('image-carousel', {
    ...
    callback: function(x, y) {
      var active = parseInt(y*2);
      console.log(y, active);
      $('.vtab.active').removeClass('active');
      $('.vtab:eq('+active+')').addClass('active');
    }
  });
  
$(document).on('click', '.vtab', function(e) {
  var eq = $(this).index();
